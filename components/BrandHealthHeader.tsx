...
function riskLabel(score: number): { label: string; color: string } {
  if (score >= 70) return { label: "Healthy", color: "text-emerald-600 bg-emerald-50 ring-emerald-200" };
  if (score >= 50) return { label: "Moderate risk", color: "text-amber-600 bg-amber-50 ring-amber-200" };
  return { label: "High risk", color: "text-rose-600 bg-rose-50 ring-rose-200" };
}
